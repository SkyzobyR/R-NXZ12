...
const sections = [
   {
    title: `✃ INFO`,
	rows: [
	    {title: "🔮WhatsApp Imune 1", rowId: '.waimune1', description: 'Jangan lupa Subs Yt 𝐑-𝐍𝐗𝙕' },
	    {title: "🔮WhatsApp Imune 2", rowId: '.waimune2', description: 'Jangan lupa Subs Yt 𝐑-𝐍𝐗𝙕' },
	{title: "🔮WhatsApp Gb Kebal 1", rowId: '.wagb1', description: 'Jangan lupa Subs Yt 𝐑-𝐍𝐗𝙕' },
